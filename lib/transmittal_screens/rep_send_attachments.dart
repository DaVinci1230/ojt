...
import 'package:ojt/transmittal_screens/reprocessing_menu.dart';
...
import 'rep_view_files.dart';
import 'uploader_menu.dart';
import 'uploader_viewfiles.dart'; 
...
class RepSendAttachment extends StatefulWidget {
  ...
  @override
  _RepSendAttachmentState createState() => _RepSendAttachmentState();
}

class _RepSendAttachmentState extends State<RepSendAttachment> {
  ...
  try {
    var result = await TransmitterAPI().uploadTransactionOrFile(
      ...
      secAttachments: widget.secAttachments.toList(),
    );
