...
import 'package:ojt/transmittal_screens/reprocess_no_support.dart';
...
class ReprocessDetailsNoSupport extends StatefulWidget {
  final Transaction transaction;
  final List<String> selectedDetails;

  ReprocessDetailsNoSupport({
    Key? key,
...
class _TransmitterSendAttachmentState extends State<ReprocessDetailsNoSupport> {
                  ...
                  onPressed: _isLoading
                      ...
                      : () {
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => FetchReprocessNoSupport (key: Key('value')),
                            ),
                          );
                        },
