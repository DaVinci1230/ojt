...
class UploaderNoSupportDetails extends StatefulWidget {
  final Transaction transaction;
  final List<String> selectedDetails;

  UploaderNoSupportDetails({
    Key? key,
  ...
  @override
  _UploaderNoSupportDetailsState createState() => _UploaderNoSupportDetailsState();
}
...
class _UploaderNoSupportDetailsState extends State<UploaderNoSupportDetails> {
                    ...
                    onPressed: _isLoading
                        ...
                        : () {
                            ...
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => UploaderNoSupport(key: Key('value')),
                              ),
                            );
                          },
