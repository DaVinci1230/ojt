...
// class TransmitterSecondAddAttachment extends StatefulWidget {
//   final Transaction transaction;

//   const TransmitterSecondAddAttachment({
//     Key? key,
...
//   @override
//   _TransmitterSecondAddAttachmentState createState() =>
//       _TransmitterSecondAddAttachmentState();
// }
...
// class _TransmitterSecondAddAttachmentState extends State<TransmitterSecondAddAttachment> {
//   int _selectedIndex = 0; // Initialize with the correct index for Upload
//   List<Map<String, dynamic>> secAttachments = [];
//   String? _fileName;
...
//                     ),
//                   const SizedBox(height: 20.0),
//                   for (var attachment in secAttachments)
...
//                         ElevatedButton(
//                           onPressed: () {
//                             List<Map<String, String>> secAttachmentsString =
//                                secAttachments
...
//                             for (var attachment in secAttachmentsString) {
//                               if (attachment['name'] == null ||
...
//           onPressed: () {
//             setState(() {
//               secAttachments.removeWhere((element) => element['name'] == fileName);
//               developer.log('Attachment removed: $fileName');
//               developer.log('Attachments array after removing: $secAttachments');
//             });
//           },
