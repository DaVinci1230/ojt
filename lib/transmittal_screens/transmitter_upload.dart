...
import 'package:ojt/transmittal_screens/transmitter_homepage.dart';
import 'package:scrollable_table_view/scrollable_table_view.dart';
import '../models/user_transaction.dart'; // Import your Transaction model
import 'transmitter_menu.dart';
import 'transmitter_send.dart';

class transmitterUpload extends StatefulWidget {
  const transmitterUpload({Key? key}) : super(key: key);

  @override
  _transmitterUploadState createState() => _transmitterUploadState();
}

class _transmitterUploadState extends State<transmitterUpload> {
  ...
  Future<void> fetchTransactions() async {
    try {
      final response = await http.get(Uri.parse(
          'http://192.168.68.109/localconnect/fetch_transaction_data.php'));
