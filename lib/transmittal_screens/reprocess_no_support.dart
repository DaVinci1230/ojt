...
import 'package:ojt/transmittal_screens/fetch_reprocessing.dart';
import 'package:scrollable_table_view/scrollable_table_view.dart';
import '../models/user_transaction.dart';
import 'reprocess_details.dart';
import 'reprocess_details_no_support.dart';
import 'reprocessing_menu.dart';
import 'transmitter_homepage.dart';

class FetchReprocessNoSupport extends StatefulWidget {
  const FetchReprocessNoSupport({Key? key}) : super(key: key);

  @override
  _FetchReprocessNoSupportState createState() => _FetchReprocessNoSupportState();
}

class _FetchReprocessNoSupportState extends State<FetchReprocessNoSupport> {
  ...
  void navigateToDetails(Transaction transaction) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => ReprocessDetailsNoSupport(
